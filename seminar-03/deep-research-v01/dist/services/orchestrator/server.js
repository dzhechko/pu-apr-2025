...
const ask_routes_1 = __importDefault(require("./routes/ask.routes"));
...
// API Routes
app.use('/api/ask', ask_routes_1.default);
...
// Start server
const PORT = config_1.default.services.orchestrator.port;
app.listen(PORT, () => {
